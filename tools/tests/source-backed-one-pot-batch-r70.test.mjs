...
const expected = [
  ...
  ['taiwan-red-rice-banana-rice', '红米香蕉饭', 'recipe_fact_checked'],
  ['taiwan-taro-rice-aroma', '芋飯飄香', 'recipe_fact_checked'],
...
test('r70 keeps high-risk, non-rice, and multi-stage boundaries explicit', () => {
  ...
  assert.match(byId.get('hongdong-steamed-rice')?.evidence_notes ?? '', /红枣|喜宴|蒸饭/);

...
const expected = {
  'jp-miyagi-hokki-meshi': ['shellfish_fully_cooked', null, 'S-SAFETY-TEMPERATURES-1'],
  'jp-ehime-tako-meshi': ['seafood_fully_cooked', 63, 'S-SAFETY-SEAFOOD-GENERAL-CDC-1'],
  'maff-miyagi-harako-meshi': ['seafood_fully_cooked', 63, 'S-SAFETY-SEAFOOD-GENERAL-CDC-1'],
};

test('r268 closes three directly evidenced MAFF regional seafood endpoints', () => {
...
test('r268 preserves the staged MAFF processes and does not promote entries', () => {

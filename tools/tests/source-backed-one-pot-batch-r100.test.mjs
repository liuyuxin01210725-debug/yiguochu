...
const expectedStatus = new Map([
  ...
  ['r100-macau-tomato-chicken-rice', 'recipe_fact_checked'],
  ['r100-macau-high-fiber-brown-fried-rice', 'recipe_fact_checked'],
  ['r100-hk-corn-pumpkin-chicken-ball-rice', 'recipe_fact_checked'],

...
const expected = {
  'midea-beef-pumpkin-rice': {
    code: 'beef_fully_cooked',
    temperature: 71,
    locator: /beef|牛肉|71/u,
  },
  'panasonic-taiwan-golden-snapper-rice': {
    code: 'seafood_fully_cooked',
    temperature: 63,
    locator: /fish|snapper|鲷|63/u,
  },
  'iris-rc-pga-chicken-rice': {
...
test('r261 closes three directly evidenced same-cooker protein safety gaps', () => {
...
test('r261 keeps model-scoped contracts and non-executable status unchanged', () => {

...
test('keeps research entries non-public after signed contracts are admitted', () => {
  ...
  assert.deepEqual(
    ...
    ['tiger-chicken-bamboo-rice', 'tiger-whitefish-mixed-rice', 'tiger-chinese-sticky-rice', 'panasonic-claypot-style-chicken-rice', 'tatung-avocado-chicken-rice', 'r61-tiger-easy-khao-man-gai', 'tiger-post-196-gomoku-rice', 'tiger-usa-century-egg-fish-porridge', 'illinois-texas-hash'],
  );

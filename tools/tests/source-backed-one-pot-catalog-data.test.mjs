...
test('r57 collection batch records first-party vendor, institutional and regional one-pot candidates without promoting research', () => {
  ...
  assert.equal(catalog.catalog_version, 'source-backed-one-pot-v1-20260808-global-r158');
...
test('keeps research entries non-public after signed contracts are admitted', () => {
  ...
  assert.deepEqual(
    ...
    ['tiger-chicken-bamboo-rice', 'tiger-whitefish-mixed-rice', 'tiger-chinese-sticky-rice', 'panasonic-claypot-style-chicken-rice', 'hk-pumpkin-taro-chicken-claypot-rice', 'hk-taro-shrimp-multigrain-steamed-rice', 'tatung-avocado-chicken-rice', 'tiger-pork-bamboo-rice', 'tiger-steak-mushroom-barley-rice', 'tiger-beef-matsutake-rice', 'tiger-oyster-mushroom-rice', 'tatung-seafood-porridge', 'r61-tiger-easy-khao-man-gai', 'tiger-post-196-gomoku-rice', 'tiger-usa-century-egg-fish-porridge', 'illinois-texas-hash'],
...
test('r52 collection batch records directly opened Tatung electric-pot rice meals without promoting research', () => {
  ...
  const expected = [
    ...
    ['tatung-wakayama-ginger-rice', 'しょうが飯', 'recipe_fact_checked'],

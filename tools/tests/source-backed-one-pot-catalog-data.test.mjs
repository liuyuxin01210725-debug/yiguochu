...
test('keeps research entries non-public after signed contracts are admitted', () => {
  ...
  assert.deepEqual(
    ...
    ['tatung-hainan-chicken-rice', 'tatung-pork-jowl-sesame-rice', 'tiger-duck-matsutake-rice', 'sichuan-rice-cooker-pork-ribs-rice', 'tatung-avocado-chicken-rice', 'tiger-beef-matsutake-rice', 'tiger-oyster-mushroom-rice', 'tiger-post-196-gomoku-rice', 'tiger-chicken-paella', 'tiger-gomoku-rice-post43', 'instant-pot-spanish-chicken-rice', 'illinois-texas-hash', 'va-pork-rice-skillet', 'usu-salsa-verde-chicken-rice', 'cu-caribbean-jerk-chicken-rice', 'kidney-care-chicken-tikka-pulao', 'firststeps-turkey-vegetable-pilaf'],

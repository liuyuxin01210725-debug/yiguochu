...
当前结构化目录版本为 `source-backed-one-pot-v1-20260804-national-r36`，共 176 条：
...
3. **腊味煲仔饭**：农粮署独立砂锅版已有 3 杯米和 1:1.3 米水比，但没有固定成品份数和完整总时间。
...
6. **冬菇滑鸡饭**：已有地域/家族证据和一条直接配方，但来源权限、固定份数与完整总时间尚未闭合。
...
3. 为手抓饭选定一个明确器具版本，寻找同时写明米量和液体对象的同一来源；
4. 为腊味煲仔饭和冬菇滑鸡饭寻找同一版本内的成品份数与完整时间；
...
- 版本 `r36` 现有状态分布：`executable=10`、`recipe_fact_checked=165`、`identity_verified=1`；

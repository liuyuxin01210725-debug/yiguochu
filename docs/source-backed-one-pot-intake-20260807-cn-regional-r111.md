...
- 20 条中 **4 条是新线索**（#5–#8），**13 条是现有目录证据升级**（#1–#4、#9–#16、#20；#20 与 #4 属同一 canonical 家族，不新增第二条），**3 条为非米饭或形态未确认的边界项**（#17–#19）。#7 虽是新线索，但仅证明携行饭器具，不能直接进入主餐轮替。
...
- #5–#8 先停在研究层；缺项补齐前不得进入 B 架。#7 上杭箪饭只证明草编饭苞水煮饭，若产品边界坚持“菜饭/一锅米饭”，应作为器具文化资料而非主餐。

...
| いがい飯 | 鸟取青谷贻贝饭 | JP-TOTTORI | japanese-regional-rice | 研究记录（非公开可执行） | 米；贻贝肉 | identity、ingredients、process、quantity | 缺 liquid、time、safety | [いがい飯 鳥取県](https://www.maff.go.jp/j/keikaku/syokubunka/k_ryouri/search_menu/menu/igai_meshi_tottori.html) |

...
| 牛肉きのこごはん 卵黄仕上げ | 牛肉菌菇蛋黄饭 | JP | japanese-rice-cooker-recipes | 研究记录（非公开可执行） | 米；薄切牛肉；舞茸；蟹味菇；胡萝卜；蛋黄 | appliance、identity、ingredients、process、quantity | 缺 liquid、time、safety | [牛肉きのこごはん 卵黄仕上げ](https://www.maff.go.jp/j/keikaku/syokubunka/culture/wagohan/articles/2111/spe3_02.html) |
...
| One Pot Chicken and Brown Rice Dinner | Instant Pot一锅鸡肉糙米饭 | 非地域·厂商食谱 | 厂商电饭煲食谱 | 研究记录（非公开可执行） | 未煮糙米；去骨鸡肉；鸡汤；洋葱；胡萝卜；西芹；蘑菇 | appliance、identity、ingredients、liquid、process、quantity、time | 缺 safety | [One Pot Chicken and Brown Rice Dinner](https://instantpot.com/blogs/recipes/one-pot-chicken-and-brown-rice-dinner) |

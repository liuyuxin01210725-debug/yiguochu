...
| `adversarial-009-gluten-free-noodles-a` | 米粒卷心菜杂蔬汤 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | |
| `adversarial-011-vegan-restrictions-a` | 扁豆土豆番茄咖喱 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | |
| `adversarial-013-leaf-vegetable-water-release-a` | 简化一锅鸡肉香料饭 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | |
| `adversarial-015-rice-water-mismatch-a` | 中式基础粥 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | □通过 / □不通过 | |

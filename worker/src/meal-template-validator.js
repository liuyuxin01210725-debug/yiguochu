...
const TAXONOMY_VERSION = 'taxonomy-v1-20260802-r12';
...
export function validateMealTemplateCatalog(catalog, taxonomy, recipeLibrary, ratioCatalog, riceMealCatalog) {
  try {
    ...
    if (catalog.template_catalog_version !== 'templates-v2-20260731-r18') errors.push('template_catalog_version must be templates-v2-20260731-r18');
